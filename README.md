...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-astro-serverless)

- Server-side rendered [Astro](https://astro.build/) application deployed serverlessly.
- Uses the purpose-built [Astro web resource](https://docs.stacktape.com/compute-resources/astro-website/) that runs the
...
```bash
stacktape init --starterId astro-serverless
```
